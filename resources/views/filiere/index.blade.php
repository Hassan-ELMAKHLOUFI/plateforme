            ...
            <table class="table table-bordered">
                ...
                @foreach($filieres as $key=>$filiere)
                    <tr>
                        ...
                        <td>
                            <a data-id_filiere="{{$filiere->id_filiere}}" data-nom="{{$filiere->nom}}"
                               data-nombre_inscrit="{{$filiere->nombre_inscrit}}"
                               data-id_departement="{{$filiere->id_departement}}" data-toggle="modal"
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{route('filiere.store')}}" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="nombre_inscrit" class="form-control"
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{route('filiere.update','id_filiere')}}" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nombre_inscrit" name="nombre_inscrit" class="form-control"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="id_departement" name="id_departement" class="form-control"
                                           placeholder="chef">
                                </div>
