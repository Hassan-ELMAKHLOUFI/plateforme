     ...
     <thead>
          ...
          <th>Action</th>
             ...
             @foreach($departements as $key=>$departement)
                 ...
                 <td>
                 <a data-id_departement="{{$departement->id_dep}}" data-nom="{{$departement->nom}}" data-date="{{$departement->date}}" data-chef="{{$departement->chef}}" data-toggle="modal" data-target="#exampleModal-edit"  type="button" class="btn btn-warning btn-sm">modifier</a>
                 <a data-id_departement="{{$departement->id_dep}}"  data-toggle="modal" data-target="#exampleModal-delete"class="btn btn-danger btn-sm">supprimer</a>
                 </td>
                 </tr>
             @endforeach
             </tbody>
  ...
  <div class="modal-dialog modal-notify modal-lg modal-right modal-success" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
               ...
               <input type="date" name ="date_cr" class="form-control" placeholder="nom de departement"  >
                </div> 
                 <br>
  ...
  <div class="modal-dialog modal-notify modal-lg modal-right modal-success" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
               ...
               <input type="date" id="date"name ="date_cr" class="form-control" placeholder="nom de departement"  >
                </div> 
                 <br>
